...
class TransferShapeKeyDrivers(bpy.types.Operator):
    ...
    def poll(cls, context):
        ...
        return context.active_object is not None \
               ...
               and bpy.context.active_object.mode == "OBJECT" and context.active_object.mesh_data_transfer_object.arm_source is not None

    def execute(self, context):

        active = context.active_object
        active_prop = active.mesh_data_transfer_object
...
class TransferMeshData(bpy.types.Operator):
    ...
    def poll(cls, context):
        if context.active_object is None or context.active_object.type != "MESH":
                return False
        attributes_to_transfer = context.active_object.mesh_data_transfer_object.attributes_to_transfer
        search_method = context.active_object.mesh_data_transfer_object.search_method
        enabled = True
    ...
    def execute(self, context):
        ...
        active_prop = context.active_object.mesh_data_transfer_object
        deformed_source = active_prop.transfer_modified_source
        # sc_prop = context.scene.mesh_data_transfer_global
        as_shape_key = active_prop.transfer_shape_as_key
